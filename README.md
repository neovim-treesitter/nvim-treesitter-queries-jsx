# nvim-treesitter-queries-jsx

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsx/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jsx/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jsx**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-jsx",
...
- [ ] Changes are scoped to `jsx` — do not include files for other languages
